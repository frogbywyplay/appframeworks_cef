...
int CEF_CALLBACK media_delegate_has_vp9_support(
    struct _cef_media_delegate_t* self) {
  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING
  ...
  // Execute
  bool _retval = CefMediaDelegateCppToC::Get(self)->HasVP9Support();

  // Return type: bool
  return _retval;
}

int CEF_CALLBACK media_delegate_has_opus_support(
    struct _cef_media_delegate_t* self) {
  // AUTO-GENERATED CONTENT - DELETE THIS COMMENT BEFORE MODIFYING
