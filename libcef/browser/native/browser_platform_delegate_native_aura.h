...
class CefBrowserPlatformDelegateNativeAura : public CefBrowserPlatformDelegateNative
{
  ...
  private:
    ...
    //scoped_ptr<views::Widget> window_widget_;
    aura::Window * window_;
    static scoped_ptr<aura::WindowTreeHost> host_;
    static scoped_ptr<aura::client::FocusClient> focus_client_;
    static scoped_ptr<aura::client::DefaultCaptureClient> capture_client_;
    static scoped_ptr<aura::client::WindowTreeClient> window_tree_client_;
