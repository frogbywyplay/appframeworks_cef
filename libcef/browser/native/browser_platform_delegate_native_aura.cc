...
scoped_ptr<aura::WindowTreeHost> CefBrowserPlatformDelegateNativeAura::host_;
scoped_ptr<aura::client::FocusClient> CefBrowserPlatformDelegateNativeAura::focus_client_;
scoped_ptr<aura::client::DefaultCaptureClient> CefBrowserPlatformDelegateNativeAura::capture_client_;
scoped_ptr<aura::client::WindowTreeClient> CefBrowserPlatformDelegateNativeAura::window_tree_client_;
...
scoped_ptr<CefMenuRunner> CefBrowserPlatformDelegateNativeAura::CreateMenuRunner() {
  return NULL;
}
